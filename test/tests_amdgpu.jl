...
@testitem "TestBackend" setup=[JACCTestItem] tags=[:amdgpu] begin
    @test JACC.JACCPreferences.backend == "amdgpu"
end

@testitem "zeros_type" setup=[JACCTestItem] tags=[:amdgpu] begin
    N = 10
...
@testitem "ones_type" setup=[JACCTestItem] tags=[:amdgpu] begin
    N = 10
