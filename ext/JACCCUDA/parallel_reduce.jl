...
function JACC.parallel_reduce(N::Integer, f::Function, x::JACCArgsList{<:CuArray})
  numThreads = 512
...
function JACC.parallel_reduce((M, N)::Tuple{Integer,Integer}, f::Function, x::JACCArgsList{<:CuArray})
  numThreads = 16
