...
function JACC.parallel_for(::JACCArrayType{<:oneAPI.oneArray},(M, N)::Tuple{Integer, Integer}, f::Function, x...)
	maxPossibleItems = 16
...
function JACC.parallel_reduce(::JACCArrayType{<:oneAPI.oneArray}, N::Integer, f::Function, x...)
	numItems = 256
...
function JACC.parallel_reduce(::JACCArrayType{<:oneAPI.oneArray}, (M, N)::Tuple{Integer, Integer}, f::Function, x...)
	numItems = 16
...
function __init__()
	...
	const JACC.JAT = JACCArrayType{oneAPI.oneArray}()
end
